...
const panels = [
  ["New Task — filing", "The four-across top row, terms, link, share row. No Humperdink paste box: a Send to Hot Task payload pasted anywhere on an LOI Check imports.", render({})],
